...
class china():
    ...
    def url_1():
        ...
        name_list = list()
        url = 'https://angelsname.com/chinese-names'
    ...
    def url_2():
        ...
        #---------------------first run-----------------------
        # url2_list = list()
        # url = 'https://adoption.com/baby-names/origin/chinese'
    ...
    def file_append(file_1, file_2):
        ...
        new_df.to_csv('china_names.csv')



if __name__ == '__main__':

    # name_list = china.url_2()
    # china.file_create(name_list)

    file_1 = 'names.csv'
    file_2 = 'adopt_names.csv'

    china.file_append(file_1,file_2)